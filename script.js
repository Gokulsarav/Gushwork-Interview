document.addEventListener("DOMContentLoaded", function () {
  ...
  faqEntries.forEach(function (entry) {
    ...
    trigger.addEventListener("click", function () {
      ...
      faqEntries.forEach(function (faq) {
        ...
        faq.querySelector(".faq-toggle i").className =
      ...
      if (!wasOpen) {
        ...
        entry.querySelector(".faq-toggle i").className =
    ...
    function renderStep(idx) {
      ...
      if (checkList && mfgData[idx]) {
        ...
        mfgData[idx].checklist.forEach(function (text) {
          ...
          li.innerHTML =
            '<img src="./assets/icons/check-circle.svg" class="check-icon" alt="Check"> ' +
            text;
  ...
  // Announcement Banner Scroll Trigger
  const banner = document.querySelector(".announcement-banner");
  const triggerSection = document.querySelector(".mfg-section");
